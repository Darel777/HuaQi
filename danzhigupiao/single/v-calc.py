...
def test():
        ...
        print (Transaction(data['code'],int(data['T']),int(data['dt']),int(data['phiindex']),int(data['Q'])))
        return str(Transaction(data['code'],int(data['T']),int(data['dt']),int(data['phiindex']),int(data['Q'])))
